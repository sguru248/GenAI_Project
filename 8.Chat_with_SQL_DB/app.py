...
INJECTION_WARNING = """
                   SQL agent can be vulnerable to prompt injection. use the DB role with limitated Permmision.
...
#Radio option
radio_opt = ['Use SQLlite3 Databse - Student.db','Connect to you sql Database']
...
if radio_opt.index(selected_opt) == 1:
    ...
    mysql_password = st.sidebar.text_input("SQL Password",type="password")
